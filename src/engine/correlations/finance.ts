...
const CREDIT_CARD_BINS_FR: Record<string, CardBinInfo> = {
  'Visa Débit': { prefixes: ['4'], length: 16 },
  'Visa Crédit': { prefixes: ['4'], length: 16 },
  'Mastercard Débit': { prefixes: ['51','52','53','54','55','2221','2222','2223','2224','2225','2226','2227','2228','2229','223','224','225','226','227','228','229','23','24','25','26','27','2720'], length: 16 },
  'Mastercard Crédit': { prefixes: ['51','52','53','54','55','2221','2222','2223','2224','2225','2226','2227','2228','2229','223','224','225','226','227','228','229','23','24','25','26','27','2720'], length: 16 },
  'American Express': { prefixes: ['34','37'], length: 15 },
  'CB': { prefixes: ['539970','539971','539972'], length: 16 },
  'Maestro': { prefixes: ['5018','5020','5038','5893','6304','6759','6761','6762','6763'], length: 16 },
};
